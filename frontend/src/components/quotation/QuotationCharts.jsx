  ...
  const data = useMemo(() => {
    ...
    historico_indicadores.forEach((it) => {
      ...
      map.set(year, {
        ...
        dividends:
          typeof it.dividendosAnuais === "number" ? it.dividendosAnuais : 0,
      });
    });
      ...
      >
        ...
        {info.dividends && (
          <div style={{ fontSize: 13, marginBottom: 4 }}>
            ...
            <strong>
              R${" "}
              {Number(info.dividends.value).toLocaleString(undefined, {
        ...
        {info.dy && (
          <div style={{ fontSize: 13 }}>
            ...
            <strong>
              {Number(info.dy.value).toLocaleString(undefined, {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
              })}
              %
  ...
  return (
    <div className="w-full h-80 p-4 bg-transparent">
      <ResponsiveContainer width="100%" height="100%">
        <ComposedChart
          data={data}
          margin={{ top: 20, right: 48, left: 24, bottom: 8 }}
        >
          ...
          <YAxis
            ...
            orientation="left"
            tickFormatter={(v) =>
              `R$ ${Number(v).toLocaleString(undefined, {
          ...
          {/* Barras = DY (mostradas em %), eixo 'right' */}
          <Bar
            yAxisId="right"
            dataKey="dy"
            name="Dividend Yield (%)"
    ...
    <div className="w-full h-full" style={{ minWidth: 0, minHeight: 0 }}>
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <YAxis yAxisId="multiples" orientation="right" stroke="#9ca3af" />
