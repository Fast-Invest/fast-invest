...
export function TickerSearcher({ setSearchInput1, setSearchInput2, searchInput1, searchInput2, cotacoes, setInputedSymbols2, setInputedSymbols1 })
{
    return(
            ...
            <div className="grid grid-cols-2">
                <div className="flex flex-row items-center justify-center">
                    ...
                    <datalist id="cotacoes1">
                        {
                        cotacoes
                        .filter(cotacao => cotacao.ticker.toLowerCase().startsWith(searchInput1.toLowerCase()))
                        .slice(0,10)
                        .map((cotacao, index)=>(
                ...
                <div className="flex flex-row items-center justify-center">
                    ...
                    <datalist id="cotacoes2">
                        {
                            cotacoes
                                .filter(cotacao => cotacao.ticker.toLowerCase().startsWith(searchInput2.toLowerCase()))
                                .slice(0, 10)
                                .map((cotacao, index) => (
                                    <option value={cotacao.ticker} key={index}>{cotacao.nome}</option>
                                ))
