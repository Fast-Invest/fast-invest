...
export async function procurar_historico_balanco_anual_acao(periodo,ticker) 
{
    try
    {
        ...
        return {"message":"Historico de balanço da ação encontrado com sucesso","status":response.status ,"historico":response.data || null}
    }	
    catch(error)
    {
        console.log("Erro:",error)
        return {"message":"erro ao buscar historico de balanço", "status":error.response.status}
    }
}
...
export async function procurar_historico_renda_anual_acao(periodo,ticker) 
{
    try
    {
        ...
        return {"message":"Historico de renda da ação encontrado com sucesso","status":response.status ,"historico":response.data || null}
    }	
    catch(error)
    {
        console.log("Erro:",error)
        return {"message":"erro ao buscar historico de renda", "status":error.response.status}
    }
}
...
export async function procurar_historico_fluxo_de_caixa_acao(periodo,ticker) 
{
    try
    {
        ...
        return {"message":"Historico de fluxo de caixa encontrado com sucesso","status":response.status ,"historico":response.data || null}
    }	
    catch(error)
    {
        console.log("Erro:",error)
        return {"message":"erro ao buscar historico de fluxo de caixa", "status":error.response.status}
    }
}
