...
export const UserProvider = ({ children }) => {
    ...
    const [wallet, setWallet] = useState([{id: 0,nome: "Carteira Tutorial", data: "12/05/2024",filtros: [],},]);   
    ...
    return (
    <UserContext.Provider value={{ user,wallet,setWallet ,isLoggedIn,setIsLoggedIn }}>
      {children}
