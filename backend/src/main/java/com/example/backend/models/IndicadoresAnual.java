...
public class IndicadoresAnual 
{
    ...
    @Column(name = "data_demonstrativo_resultados")
    private Date dataDemonstrativoResultados;
    ...
    @Column(name = "pagamento_dividendo")
    private Double pagamentoDividendo;

    @Column(name = "dividendos_anuais")
    private Double dividendosAnuais;
